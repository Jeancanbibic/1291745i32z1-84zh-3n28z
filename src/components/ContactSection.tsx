          ...
          <div className="grid md:grid-cols-2 gap-12 items-start">
            <div className="animate-on-scroll">
              ...
              <div className="space-y-6 mb-8">
                ...
                <div className="flex items-start gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-muted-foreground">contact@socialpartner.com</p>
                  </div>
                </div>
              ...
              <div className="bg-beige-50 rounded-xl p-6 border border-beige-100">
                ...
                <p className="text-sm text-muted-foreground">Join hundreds of professionals who have transformed their careers with SocialPartner.</p>
              </div>
            </div>
